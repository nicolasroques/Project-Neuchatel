...
def load_data():
    return pd.read_csv(r'C:\Users\Nicolas\Desktop\training_data.csv')
...
model = joblib.load(r'C:\Users\Nicolas\Desktop\text_classifier_logistic_regression.pkl')
translator = GoogleTranslator(source='auto', target='en')
common_words_set = load_common_words(r'C:\Users\Nicolas\Desktop\common_words.txt')
